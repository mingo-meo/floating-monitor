...
class Monitor(QWidget):
    ...
    def update_ui_label(self):
        self.upspeed.setText(self.work_threading.upload_string)
        self.downspeed.setText(self.work_threading.download_string)
        self.cpu_num.setText("%d" % self.work_threading.cpu_percent + '%')
        self.mem_num.setText("%d" % self.work_threading.mem_percent + '%')
        self.cpu_gui.setText(self.work_threading.cpu_lines)
        self.mem_gui.setText(self.work_threading.mem_lines)
